...
export const CAMPAIGN_PRESETS = {
  fsn_2004_fuyuki: {
    ...
    openingHooks: {
      master: "深夜回家路上，街灯下自己的影子旁边贴着第二个。左手背发烫，皮肤底下三划令咒的红痕正在往外顶。",
  ...
  fsf_2008_snowfield: {
    ...
    openingHooks: {
      master: "斯诺菲尔德的沙漠公路尽头，令咒在手背浮现。干风里混着铁锈和臭氧的味道——地面在脚底下嗡了一下，像是深处的管道全开了。",
      servant: "现界的瞬间就感到不对：灵脉被人为拧过了，流向全是乱的，圣杯战争的骨架是拿别处的零件拼起来的。御主站在面前，沙漠的热风灌进来。",
  ...
  extra_2032_seraph: {
    ...
    openingHooks: {
      master: "方才还在教室里上课，下一秒视野剥离成纯白——SE.RA.PH 的走廊在脚下重新构筑，手背多了三划令咒。公告栏弹出第一轮对阵表，对手的名字亮了。",
      servant: "灵基被 Moon Cell 的数据流拽出座，以电子体重新编译。面前的御主还在发愣，Arena 入口的倒计时读数跳到了三位数。",
  ...
  extra_ccc_2032_far_side: {
    ...
    openingHooks: {
      master: "旧校舍的门在身后关上，SE.RA.PH 表侧的信号断了。走廊的墙壁在脉动，拐角处 Sakura Labyrinth 的入口张着一个人形大小的口子，里面传出心跳一样的低频。",
      servant: "灵基的数据通道被强制改写，Arena 的规则不再适用；御主和你被推入了月之裏侧——这里的法则由 BB 说了算。",
      human: "保健室的天花板在头顶慢慢融化成别的什么。门外是旧校舍，走廊尽头多出了一扇没见过的门，门缝里漏出淡粉色的光。",
    },
    activeRuleSetIds: [
  ...
  apocrypha_2004_trifas: {
    ...
    openingHooks: {
      master: "罗马尼亚千界树城塞的灯火在山脊上闪动。令咒发烫，阵营的颜色印在手背——红或者黑。身边的空气沉了一截，从者正在实体化。",
      servant: "召唤的光散去，城堡石壁的火把照亮同阵营的另外六骑从者。七对七的战争，城堡对面那座山头上亮着对家的营火。",
      human: "布加勒斯特飞特里凡的末班巴士上，窗外的天空亮了一下。那道光从地面往天上去，拖了很长的尾迹。",
    },
    activeRuleSetIds: ["fate-worldview-filter", "fate-rank-combat", "custom"],
  ...
  tsukihime_2000_misaki: {
    ...
    openingHooks: {
      human: "回三咲的末班公交上，窗外的月亮把整条河照成白的。下车时站台路灯灭了一盏——灯罩内侧沾了一片半干的黑色粘液。",
    },
    activeRuleSetIds: ["fate-worldview-filter", "custom"],
    timezone: "Asia/Tokyo",
  ...
  prototype_fragments_1991_tokyo: {
    ...
    openingHooks: {
      master: "东京夜空下，令咒的热度刺穿手套。八骑——比标准多一骑。三条街外的方向，空气薄了一层，呼吸都带着压迫感。",
  ...
  prototype_199x_tokyo: {
    ...
    openingHooks: {
      master: "绫香放学回家路上，街角的猫突然全跑了。左手背的令咒是爸爸留下来的——红色的三划纹路，和他生前照片上的一模一样。",
      servant: "第二次东京圣杯战争的召唤。御主是个十几岁的少女，手上有继承来的令咒——上次战争的气味还残留在这座城市里。",
      human: "东京某区的便利店夜班，监控画面里有一帧：两个人形从三号楼天台跳到五号楼，中间隔了十二米的车道。",
    },
    activeRuleSetIds: ["fate-worldview-filter", "fate-rank-combat", "custom"],
    timezone: "Asia/Tokyo",
  ...
  samurai_1651_edo: {
    ...
    openingHooks: {
      master: "盈月的光透过障子纸落在榻榻米上。左手背的纹样在月光下浮动——盈月之仪今夜开始。庭院石灯笼旁站着一个人形，影子比灯笼高出一截。",
      servant: "灵基在江户的月夜凝聚。脚下铺石路，头顶木造町屋的檐瓦，空气里有木炭、味噌和铁锈。一六五一年的夜风比记忆中任何一次现界都暖。",
      human: "江户街头的早市还没收摊，两国桥方向传来一声闷响，水花澆过桥栏。鱼贩抬头看了一眼，说今天是第三回了。",
    },
    activeRuleSetIds: ["fate-worldview-filter", "fate-rank-combat", "custom"],
    timezone: "Asia/Tokyo",
  ...
  redline_1945_teito: {
    ...
    openingHooks: {
      master: "灯火管制下的帝都，月光是唯一的照明。手背的令咒在防空壕的黑暗里发出微光，军部的人管这叫「圣杯战争」。头顶的防空警报刚停，耳朵还在嗡。",
      servant: "召唤完成时，头顶的水泥板在抖灰。爆击的余波从地下传上来，御主的军装沾着灰尘，防空壕外面是 1945 年的战时帝都。",
      human: "空袭结束后的黎明，废墟里的砖堆下露出一小截金属棱角，凉的，没有被火烤过的痕迹。周围的砖头全烧红了，只有这块冷得扳手。",
    },
    activeRuleSetIds: ["fate-worldview-filter", "fate-rank-combat", "custom"],
    timezone: "Asia/Tokyo",
  ...
  carnival_phantasm: {
    ...
    openingHooks: {
      custom: "Ahnenerbe 咖啡厅的门铃响了第 147 次。Saber 跟 Arcueid 一人捏着蛋糕盘子的一边僵在那里，Lancer 趴在地上，今天第二回了。",
    },
  ...
  labyrinth_fuyuki_grail: {
    ...
    openingHooks: {
      servant: "意识在石壁的冰凉中重新聚拢。灵基勉强维持着，魔力供给只够现界——亚种圣杯把你拉进来就撒手了。甬道深处传来水滴声，和一种贴着地面走的沉重拖曳音。",
      human: "探索队的通讯水晶在三小时前碎了，最后一个同伴的喊声也消失了很久。手电筒照在石壁上，石头泛着不该有的蓝色。拐角后面传来四足踏水的声音，节奏很慢，在靠近。",
    },
    activeRuleSetIds: ["fate-worldview-filter", "fate-rank-combat", "custom"],
    timezone: "Asia/Tokyo",
