...
最终正文里，否定反转句默认不用。整段不要靠“先否定普通解释，再给高级解释”制造质感。
...
否定反转句只在纠正玩家误判或制造关键反差时允许一次。需要修正感知时，改写成物理过程：光怎样变暗、边缘怎样消失、角色怎样停手、声音怎样断开。
