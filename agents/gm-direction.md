...
- `eventWeight`：渲染篇幅下限。light（≈300–500字）仅限纯过场/简单确认；normal（≈800–1200字）是默认值，凡有实质互动或推进都至少是 normal；heavy（≥1500字）用于战斗高潮/重大揭示/关系转折。不要因为本轮机械事件少就压到 light——对话轮、情绪流动同样是内容。
