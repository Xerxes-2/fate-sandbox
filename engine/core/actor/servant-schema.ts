...
export const SERVANT_FORM_EVENT_SCHEMA = Type.Union([
  SPEND_MANA_EVENT_SCHEMA,
  RESTORE_MANA_EVENT_SCHEMA,
  DAMAGE_SPIRITUAL_CORE_EVENT_SCHEMA,
  ADD_PARAM_MODIFIER_EVENT_SCHEMA,
  CHANGE_CONTRACT_EVENT_SCHEMA,
  ADD_PERMANENT_DEFECT_EVENT_SCHEMA,
]);

export type ServantFormEvent = Static<typeof SERVANT_FORM_EVENT_SCHEMA>;
