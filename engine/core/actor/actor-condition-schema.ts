...
export const ACTOR_CONDITION_EVENT_SCHEMA = Type.Union([
  ADD_WOUND_EVENT_SCHEMA,
  UPDATE_WOUND_EVENT_SCHEMA,
  ADD_AFFLICTION_EVENT_SCHEMA,
  ADD_PERMANENT_EFFECT_EVENT_SCHEMA,
  UPDATE_MAGECRAFT_CIRCUITS_EVENT_SCHEMA,
  RESOLVE_CONDITION_EVENT_SCHEMA,
  CHANGE_OUTFIT_EVENT_SCHEMA,
  TRANSFER_TRACKED_ITEM_EVENT_SCHEMA,
  UPDATE_TRACKED_ITEM_EVENT_SCHEMA,
  ADD_TRACKED_ITEM_EVENT_SCHEMA,
]);

export type ActorConditionEvent = Static<typeof ACTOR_CONDITION_EVENT_SCHEMA>;
